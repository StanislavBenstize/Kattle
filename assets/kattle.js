function FuncForKattle() {
   ...
   this.subWater = function (value) {
      if (this.currentVolumeWater > 0 && this.currentVolumeWater - this.volume >= 0) {
         return `${"Your kattle has"} ${(this.currentVolumeWater -= value)} ${"litr"}`;
      }
...
const myKattle = new Kattle("blue", 5);
